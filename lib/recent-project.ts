const KEY = "ar_pm_recent_project";
const CHANGE_EVENT = "ar-pm-recent-project-change";
...
export function getRecentProject(): { id: string; name: string } | null {
...
export function setRecentProject(id: string, name: string) {
  try {
...
export function subscribeRecentProject(callback: () => void) {
