    ...
    <div className="flex flex-1 flex-col">
      ...
      <WidthContainer mainClassName="space-y-6 px-6 py-6">
        <section className="space-y-2">
          <h2 className="text-xs font-semibold tracking-wide text-muted-foreground uppercase">포인트 컬러</h2>
        ...
        {session.user.isSuperAdmin && (
          <section className="space-y-2">
            <h2 className="text-xs font-semibold tracking-wide text-muted-foreground uppercase">계정 관리</h2>
            <p className="text-sm text-muted-foreground">
